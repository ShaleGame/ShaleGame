...
/// blend_position to the character's X velocity every frame.
/// </summary>
[GlobalClass]
public partial class SetBlendSpaceXBehavior : CharacterState
{
    [Export]
    ...
    public override State Process(double delta)
    {
        ...
        {
            float blendValue = CharacterContext.Velocity.X * Scale;
